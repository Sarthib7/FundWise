...
create index idx_telegram_link_codes_wallet on public.telegram_link_codes(wallet);
create index idx_telegram_link_codes_expires_at on public.telegram_link_codes(expires_at);
create unique index idx_telegram_wallet_links_one_active_per_user
  on public.telegram_wallet_links(telegram_id)
  where active;
create index idx_telegram_wallet_links_wallet
